...
import 'package:flow_weather/features/weather_feature/data/repository/city_repositoryimpl.dart';
...
Future<void> setup() async {
  ...
  locator.registerSingleton<CityRepository>(CityRepositoryImpl());
