...
import 'package:flow_weather/features/weather_feature/presentation/widgets/custom_error_dialog.dart';
      ...
      child: BlocListener<HomeBloc, HomeState>(
        listener: (context, state) {
          ...
          if (state.errorMessage != null) {
            CustomErrorDialog.show(context, state.errorMessage!);
              ...
              Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AppBackground.getBackGroundImage(DateFormat('kk').format(DateTime.now())),
                    fit: BoxFit.cover,
                  ),
                ),
                child: SafeArea(
                                ...
                                child: TypeAheadField<neshan.NeshanCityItem>(
                                  ...
                                  builder: (context, TextEditingController controller, FocusNode focusNode) {
                                    return TextField(
                                      ...
                                      decoration: const InputDecoration(
                                        hintText: "جستجوی شهر...",
                                        hintStyle: TextStyle(color: Colors.white70, fontWeight: FontWeight.w800),
                                  ...
                                  onSelected: (neshan.NeshanCityItem model) async {
                                    ...
                                    if (lat != null && lon != null) {
                                      ...
                                      context.read<HomeBloc>().add(SetErrorMessage('مختصات شهر پیدا نشد'));
                                    }
                                  },
                                  ...
                                  builder: (context, s2) {
                                    ...
                                    return Column(
                                      children: [
                                        ...
                                        DailySection(forecastDays: forecast.days).animate().fadeIn(duration: 300.ms).scale(),
